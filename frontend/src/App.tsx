        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3 py-1.5 bg-blue-50 hover:bg-blue-100 rounded-md text-blue-700 text-sm transition-colors"
            >
              {showChangePassword ? "Close password panel" : "Change password"}
            </button>
            <button
              onClick={handleLogout}
              className="px-4 py-1.5 bg-gray-100 hover:bg-gray-200 rounded-md text-gray-700 transition-colors"
            >
              Logout
            </button>
          </div>
          ...
          {hasSequences ? (
            <div className="flex-1 flex flex-col min-h-0 space-y-2">
              ...
              <div className="flex-none flex items-center justify-center">
                <div className="w-full max-w-4xl h-[50vh]">
                  <VideoPlayer
